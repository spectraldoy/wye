...
fn test_parse_literal() {
    ...
    assert!(
        parser.parse("0.23124").unwrap() == ast::Expression::FloatLiteral(OrderedFloat(0.23124))
    );
    assert!(
        parser.parse("1.2222E100").unwrap()
    ...
    // Ok StringLiteral
    assert!(
        parser.parse("\"hello there\"").unwrap()
            == ast::Expression::StringLiteral(String::from("hello there"))
    );
    assert!(
        parser.parse("\"µß£££ç∑ 😎\"").unwrap()
...
fn test_parse_list() {
    ...
    assert!(
        parser.parse("[-1.0e6]").unwrap()
            == ast::Expression::List(vec![ast::Expression::FloatLiteral(OrderedFloat(
                -1_000_000.0
            ))])
    );
    assert!(
        parser.parse("[4, 5]").unwrap()
...
fn test_parse_tuple() {
    ...
    assert!(
        parser.parse("(-4,)").unwrap()
            == ast::Expression::Tuple(vec![ast::Expression::IntegerLiteral(-4)])
    );
    assert!(
...
fn test_parse_identifier_type_variant() {
    ...
    assert!(
        parser.parse("identif").unwrap() == ast::Expression::Identifier(String::from("identif"))
    );
    ...
    assert!(
        parser.parse("__Option").unwrap() == ast::Expression::Identifier(String::from("__Option"))
    );
    assert!(
        parser.parse("Ty6_Var68__iant_").unwrap()
            == ast::Expression::Identifier(String::from("Ty6_Var68__iant_"))
    );
    ...
    assert!(
        parser.parse("(Thing with 4)").unwrap()
            == ast::Expression::TypeVariant(
                String::from("Thing"),
                Box::new(ast::Expression::IntegerLiteral(4))
            )
    ...
    assert!(
        parser.parse("Listy with [1, \"hell⏰\"]").unwrap()
            == ast::Expression::TypeVariant(
                String::from("Listy"),
    ...
    assert!(
        parser.parse("Bruh with (-5.2)").unwrap()
            == ast::Expression::TypeVariant(
                String::from("Bruh"),
                Box::new(ast::Expression::FloatLiteral(OrderedFloat(-5.2)))
            )
    );
    assert!(
        parser.parse("Bruh with (-5.2,)").unwrap()
            == ast::Expression::TypeVariant(
                String::from("Bruh"),
                Box::new(ast::Expression::Tuple(vec![ast::Expression::FloatLiteral(
                    OrderedFloat(-5.2)
                )]))
            )
    );
...
fn test_parse_function_application() {
    ...
    assert!(
        parser.parse("(g 4 \"hi\" (f 2))").unwrap()
            == ast::Expression::FuncApplication(
                Box::new(ast::Expression::FuncApplication(
                    Box::new(ast::Expression::FuncApplication(
                        Box::new(ast::Expression::Identifier(String::from("g"))),
    ...
    assert!(
        parser.parse("[f g, a + [], Option with 4]").unwrap()
            == ast::Expression::List(vec![
                ast::Expression::FuncApplication(
                    Box::new(ast::Expression::Identifier(String::from("f"))),
                    Box::new(ast::Expression::Identifier(String::from("g")))
    ...
    assert!(
        parser.parse("func Some 4 g 6 \"hi\"").unwrap()
            == ast::Expression::FuncApplication(
                Box::new(ast::Expression::FuncApplication(
                    Box::new(ast::Expression::FuncApplication(
                        Box::new(ast::Expression::FuncApplication(
    ...
    assert!(
        parser.parse("func (Some with 4) (g 5) \"hi\"").unwrap()
            == ast::Expression::FuncApplication(
                Box::new(ast::Expression::FuncApplication(
                    Box::new(ast::Expression::FuncApplication(
                        Box::new(ast::Expression::Identifier(String::from("func"))),
...
fn test_parse_lambda_expr() {
    ...
    assert!(
        parser.parse("\\x y -> Option with (x, y)").unwrap()
            == ast::Expression::Lambda(
                vec![String::from("x"), String::from("y")],
                Box::new(ast::Expression::TypeVariant(
                    String::from("Option"),
...
fn test_parse_match() {
    ...
    // Ok
    assert!(
        parser.parse("match a { _ => 3 }").unwrap()
        ...
        _ => 4,
            ...
            == ast::Expression::MatchConstruct(
                ...
                vec![
                    ...
                    (ast::Pattern::Wildcard, ast::Expression::IntegerLiteral(4))
                ]
            )
    );
    assert!(
        ...
        _ => 7
            ...
            == ast::Expression::MatchConstruct(
                ...
                vec![
                    ...
                    (ast::Pattern::Wildcard, ast::Expression::IntegerLiteral(7))
                ]
            )
    );
    assert!(
    ...
    assert!(
        parser.parse("match (f g) { _ => x }").unwrap()
            == ast::Expression::MatchConstruct(
                Box::new(ast::Expression::FuncApplication(
                    Box::new(ast::Expression::Identifier(String::from("f"))),
                    Box::new(ast::Expression::Identifier(String::from("g")))
...
fn test_parse_let() {
    ...
    assert!(
        parser.parse("let x y = (\\ x -> x) y;").unwrap()
            == ast::Statement::UntypedLet(
                vec![String::from("x"), String::from("y")],
                ast::Expression::FuncApplication(
                    Box::new(ast::Expression::Lambda(
                        vec![String::from("x")],
                        Box::new(ast::Expression::Identifier(String::from("x")))
                    )),
    ...
    assert!(
        parser.parse("let plus_4 x = (+) 4;").unwrap()
            == ast::Statement::UntypedLet(
                ...
                ast::Expression::Block(
                    vec![ast::Statement::UntypedLet(
                        ...
                        ast::Expression::MatchConstruct(
                            ...
                            vec![
                                (ast::Pattern::EmptyList, ast::Expression::IntegerLiteral(0)),
                                (
                                    ast::Pattern::ListConstruction(
                                        String::from("x"),
                                        String::from("xs")
                                    ),
                                    ast::Expression::FuncApplication(
    ...
    assert!(
        parser.parse("let Main = print (f g);").unwrap()
            == ast::Statement::UntypedLet(
    ...
    // Ok typed
    assert!(
        parser.parse("let z: 'a = \"hi\";").unwrap()
            == ast::Statement::TypedLet(
                String::from("z"),
                ast::TypeExpression::UniversalType(String::from("a")),
                vec![],
                ast::Expression::StringLiteral(String::from("hi"))
            )
    );
    assert!(
        parser.parse("let y: float = 5.68;").unwrap()
            == ast::Statement::TypedLet(
                String::from("y"),
                ast::TypeExpression::FloatType,
                vec![],
                ast::Expression::FloatLiteral(OrderedFloat(5.68))
            )
    );
    assert!(
        parser.parse("let x: (int) = 4;").unwrap()
            == ast::Statement::TypedLet(
                String::from("x"),
                ast::TypeExpression::IntType,
                vec![],
    ...
    assert!(
        parser.parse("let x: Option int = Some with 4;").unwrap()
            == ast::Statement::TypedLet(
                String::from("x"),
                ast::TypeExpression::DeclaredType(
                    String::from("Option"),
    ...
    assert!(
        parser.parse("let func(x:int)->(y:int)->int=4;").unwrap()
            == ast::Statement::TypedLet(
                String::from("func"),
                ast::TypeExpression::IntType,
                vec![
    ...
    assert!(
        parser
            .parse("let func (x: bool) -> int -> Option 'a = \\ y -> (+) x y;")
            .unwrap()
            == ast::Statement::TypedLet(
                String::from("func"),
                ast::TypeExpression::FunctionType(
