...
% TODO: update the spec, match patterns are comma separated
% TODO: no more if then else
...
\end{lstlisting}
the function \texttt{cons} type checks to the functional type \texttt{'a -> ['a] -> 'a}. For more information, check out the \href{{https://en.wikipedia.org/wiki/Hindley%E2%80%93Milner_type_system}}{the Hindley-Milner type system}.
\newpage
